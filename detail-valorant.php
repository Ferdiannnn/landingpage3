    ...
    <div>
        <div class="container">
            <div class="row mt-4">
                ...
                <?php $id = $_GET["id"]; ?>
                <?php   $ambil=$conn->query("SELECT * FROM valorant WHERE id = '$id'")  ?>
                ...
                <div class="col-sm-3">
                    ...
                    <h3 class="mt-4">Penjual</h3>
                    <p><?php echo $pecah['username'] ?></p>
                </div>
                <div class="col-sm-3 mt-3">
                    ...
                    <br>
                    <a href=<?php echo $pecah['kontak'] ?> terget='_blank' class="btn btn-danger beli">Beli</a>
