        ...
        <div class="container">
            <div class="row mt-4">
                ...
                <div class="col-sm-3 mt-3">
                    ...
                    <?php 
                                if($pecah["stok"] == 0){
                                    echo "<a href='' class='btn btn-danger'style='width: 180px;'>Habis</a>";
                                    ;

                                }else{
                                    echo "<a href='/website/landingpage/midtrans/examples/snap/checkout-process-simple-version.php?order_id=$order_id' class='btn btn-danger'style='width: 180px;'>Beli</a>";
                                }
                            ?>
